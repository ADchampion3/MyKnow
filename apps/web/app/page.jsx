...
export default function Page() {
  ...
  const importFile = async (event) => {
    ...
    try {
      ...
      payload.set("ocrMode", isPdf ? event.currentTarget.ocrMode.value : "off");
      payload.set("ocrProvider", isPdf ? event.currentTarget.ocrProvider.value : "local");
